...
class Exam extends Model
{
	...
	public function getQuestionPoolAttribute($value)
	{
		if($value == "static"){
			return array('label'=>'Static', 'value'=>'static');
		}else{
			return array('label'=>'Random', 'value'=>'random');
		}
	...
	{
        if($value){
            return array('label'=>Exam::$enum_exam_type[$value], 'value'=>$value);
        }
