                ...
                <div class="card">
                    <div class="card-header">
                        <span class="cui-utils-title">
                            <strong> View Answers Types</strong>
                        ...
                        <div class="row card-with-shadow pt-3 custom-shadow">
                            ...
                            <div class="w-100">
                                <div class="mb-5">
                                    ...
                                    <back-to-index :linkname="'answers_types.index'"></back-to-index>
                                </div>
                            </div>
                        </div>
                    </div>
...
export default {
    ...
    computed: {
        ...mapGetters('AnswersTypesSingle', ['item'])
    },
    watch: {
    ...
    methods: {
        ...mapActions('AnswersTypesSingle', ['fetchData', 'resetState']),
        toggleColumns(){
