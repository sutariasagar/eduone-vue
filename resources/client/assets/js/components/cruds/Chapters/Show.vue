                    ...
                    <div class="card-body ">
                        <div class="row card-with-shadow pt-3 custom-shadow">
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <back-to-index :linkname="'chapters.index'"></back-to-index>
                                </div>
                            </div>
                        </div>
                    </div>
...
export default {
    ...
    computed: {
        ...mapGetters('ChaptersSingle', ['item'])
    },
    watch: {
    ...
    methods: {
        ...mapActions('ChaptersSingle', ['fetchData', 'resetState']),
        toggleColumns(){
