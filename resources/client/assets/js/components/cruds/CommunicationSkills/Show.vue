                ...
                <div class="card">
                    <div class="card-header">
                        <span class="cui-utils-title">
                          <strong> View Communication Skills</strong>
                    ...
                    <div class="card-body ">
                        <div class="row card-with-shadow pt-3 custom-shadow">
                            ...
                            <div class="w-100">
                                ...
                                <back-to-index :linkname="'communication_skills.index'"></back-to-index>
                                </div>
                            </div>
                        </div>
                    </div>
...
export default {
    ...
    computed: {
        ...mapGetters('CommunicationSkillsSingle', ['item'])
    },
    watch: {
    ...
    methods: {
        ...mapActions('CommunicationSkillsSingle', ['fetchData', 'resetState']),
        toggleColumns(){
