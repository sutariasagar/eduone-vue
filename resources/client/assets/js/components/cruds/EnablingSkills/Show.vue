                ...
                <div class="card">
                    <div class="card-header">
                        <span class="cui-utils-title">
                          <strong> View Enabling Skills</strong>
                                    ...
                                    <table class="table table-bordered table-striped">
                                        <tbody>
                                          ...
                                          <tr>
                                                <th>Skills</th>
                                                <td>
                                                    <span class="label label-info" v-for="skill in item.skill">
                                                        {{ skill.title }}
                                                    </span>
                                                </td>
                                            </tr>
...
export default {
    ...
    computed: {
        ...mapGetters('EnablingSkillsSingle', ['item'])
    },
    watch: {
    ...
    methods: {
        ...mapActions('EnablingSkillsSingle', ['fetchData', 'resetState']),
        toggleColumns(){
