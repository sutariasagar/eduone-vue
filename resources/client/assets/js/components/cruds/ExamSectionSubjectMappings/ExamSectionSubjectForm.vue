    ...
    <form @submit.prevent="submitForm" novalidate>
        <div class="box">
            ...
            <div class="box-body">
                ...
                <input type="hidden" name="exam_section_id" :value="section.id">
...
export default {
    ...
    mounted() {
        ...
        context.updateExam_section_id(context.section.id);
    },
    destroyed() {
        this.resetState()
    },
    methods: {
        ...mapActions('ExamSectionSubjectMappingsSingle', ['storeData', 'resetState', 'setExam_section', 'setMin_questions', 'setMax_questions', 'setChapter', 'setTopic', 'setSubTopic', 'fetchExamsectionsAll', 'fetchChaptersAll', 'fetchTopicsAll', 'fetchSubTopicsAll','setExam_section_id']),
