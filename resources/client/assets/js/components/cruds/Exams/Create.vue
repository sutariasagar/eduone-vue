                                            ...
                                            <div class="box">
                                                ...
                                                <div class="box-body">
                                                    ...
                                                    <div class="form-group row" v-if="item.question_pool && item.question_pool.value == 'static'" v-bind:class="{ 'has-danger': errors && errors['question_set'] }">
                                                        <div class="col-md-3">
                                                            <label for="question_pool">Question Set <span
                                                                    class="text-danger">*</span></label>
                                                        </div>
                                                        <div class="col-md-9">
                                                            <v-select
                                                    ...
                                                    <div class="form-group row" >
                                                        ...
                                                        <div class="col-md-9">
                                                        <div class="row">
                                                            <div class="col-md-5" v-bind:class="{ 'has-danger': errors && errors['instruction_type'] }">
                                ...
                                <div class="w-100">
                                    <div class="mb-5">
                                        ...
                                        <custom-collapse-body uniqueId="speaking">
                                            <section-form :loadSectionTable="loadTables" :ref="item.speakingsection.type" v-on:showForm="showSectionSubjectFormModal" :section="item.speakingsection" :sectionid="item.speakingsection.id"></section-form>
                                        </custom-collapse-body>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="w-100">
                                    <div class="mb-5">
                                        ...
                                        <custom-collapse-body uniqueId="writing">
                                            <section-form :loadSectionTable="loadTables" :ref="item.writingsection.type" v-on:showForm="showSectionSubjectFormModal" :section="item.writingsection" :sectionid="item.writingsection.id"></section-form>
                                        </custom-collapse-body>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="w-100">
                                    <div class="mb-5">
                                        ...
                                        <custom-collapse-body uniqueId="reading">
                                            <section-form :loadSectionTable="loadTables" :ref="item.readingsection.type" v-on:showForm="showSectionSubjectFormModal" :section="item.readingsection" :sectionid="item.readingsection.id"></section-form>
                                        </custom-collapse-body>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="w-100">
                                    <div class="mb-5">
                                        ...
                                        <custom-collapse-body uniqueId="listeningsstsection">
                                            <section-form :loadSectionTable="loadTables" :ref="item.listeningsstsection.type" v-on:showForm="showSectionSubjectFormModal" :section="item.listeningsstsection" :sectionid="item.listeningsstsection.id"></section-form>
                                        </custom-collapse-body>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="w-100">
                                    <div class="mb-5">
                                        ...
                                        <custom-collapse-body uniqueId="listeningrolsection">
                                            <section-form :loadSectionTable="loadTables" :ref="item.listeningrolsection.type" v-on:showForm="showSectionSubjectFormModal" :section="item.listeningrolsection" :sectionid="item.listeningrolsection.id"></section-form>
                                        </custom-collapse-body>
                                    </div>
                                </div>
                            </div>
...
export default {
    ...
    methods: {
        ...
        "setInstruction_type",
        "fetchCoursesAll",
        "fetchQuestionSetsAll",
        "resetSubjectChapterForm",
        "setSubjectChapterFormData"
        ]),
        updateTitle(e) {
