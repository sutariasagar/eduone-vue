                ...
                <div class="card">
                    <div class="card-header">
                        <span class="cui-utils-title">
                          <strong> Update Learning Material Document</strong>
                                            ...
                                            <div class="box">
                                                <div class="box-body">
                                                    ...
                                                    <div class="form-group row" v-bind:class="{ 'has-danger': errors && errors['learning_material'] }">
                                                        <label for="learning_material" class="col-md-3 col-form-label">Learning Material *</label>
                                                        <div class="col-md-9">
                                                            <v-select
                                                    ...
                                                    <div class="form-group row" v-bind:class="{ 'has-danger': errors && errors['material_type'] }">
                                                        <label for="material_type" class="col-md-3 col-form-label">Material type *</label>
                                                        <div class="col-md-9">
                                                    ...
                                                    <div class="form-group row" >
                                                        <div class="col-md-3"><label for="mandatory">Must Read *</label></div>
                                                        <div class="col-md-9">
                                                            <div class="row">
                                                                <div class="col-md-2" v-bind:class="{ 'has-danger': errors && errors['mandatory'] }">
                                                        ...
                                                        <div class="col-md-9">
                                                            ...
                                                            >
                                                                ...
                                                                <template slot="files" slot-scope="image_props">
                                                                    <div>
                                                                    <ul v-if="item.upload_file" class="list-unstyled">
                                                                            <li v-for="file in item.upload_file" v-if="item.upload_file">
                                                                                {{ file.file_name }}
                                                                                <button
...
export default {
    ...
    methods: {
        ...mapActions('LearningMaterialDocumentsSingle', ['fetchData', 'updateData', 'resetState', 'setUpload_file', 'setCredits', 'setLearning_material','setMaterial_type', 'fetchLearningmaterialsAll', 'fetchMaterialtypesAll','removeUploadFile',"setIncludeInFreePackage","setDescription"]),
        updateTitle(e) {
