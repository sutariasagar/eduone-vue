<template>
    <section class="card" >
        <custom-data-table :columns="columns" :url="'/api/v1/learning-material-documents'" :id="'LearningMaterialDataTable'" :load="loadTables" :xprops="xprops"></custom-data-table>
    </section>
</template>
...
export default {
    data() {
        return {
            xprops: {
                module: 'LearningMaterialDocumentsIndex',
                route: 'learning_material_documents',
                permission_prefix: 'learning_material_document_',
                eventbus: new Vue()
            },
            columns: [
                ...
                {data:'updated_at', name: 'updated_at', searchable: true, label: "Updated At", group: 'basic'},
    ...
    computed: {
        ...mapGetters('LearningMaterialDocumentsIndex', ['data', 'total', 'loading', 'relationships']),
    },
    methods: {
        ...mapActions('LearningMaterialDocumentsIndex', ['fetchData', 'setQuery', 'resetState']),
        showTable() {
