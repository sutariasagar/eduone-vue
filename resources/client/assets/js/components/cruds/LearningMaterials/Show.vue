                ...
                <div class="card">
                    <div class="card-header">
                        <span class="cui-utils-title">
                          <strong> View Learning Materials</strong>
                    ...
                    <div class="card-body ">
                        <div class="row card-with-shadow pt-3 custom-shadow">
                            ...
                            <div class="w-100">
                                <div class="mb-5">
                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tr>
                                            <th>Topic</th>
                                            <td>
                                                <span class="label label-info" v-if="item.topic !== null">
                                                    {{ item.topic.title }}
                                                </span>
                                            </td>
                                        </tr>
                                ...
                                <back-to-index :linkname="'learning_materials.index'"></back-to-index>
                                </div>
                            </div>
...
export default {
    ...
    computed: {
        ...mapGetters('LearningMaterialsSingle', ['item'])
    },
    watch: {
    ...
    methods: {
        ...mapActions('LearningMaterialsSingle', ['fetchData', 'resetState']),
        toggleColumns(){
