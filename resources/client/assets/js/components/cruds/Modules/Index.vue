<template>
    <section class="card" >
        <custom-data-table :columns="columns" :url="'/api/v1/modules'" :id="'ModulesDataTable'" :load="loadTables" :xprops="xprops"></custom-data-table>
    </section>
</template>
...
export default {
    ...
    computed: {
        ...mapGetters('ModulesIndex', ['data', 'total', 'loading', 'relationships']),
    },
    methods: {
        ...mapActions('ModulesIndex', ['fetchData', 'setQuery', 'resetState']),
        showTable() {
