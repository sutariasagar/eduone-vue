                                        ...
                                        <div class="box">
                                            <div class="box-body">
                                                ...
                                                <div class="form-group row" v-bind:class="{ 'has-danger': errors && errors['unique_package_name'] }">
                                                    <label for="unique_package_name" class="col-md-3 col-form-label">Unique Package Name * </label>
                                                    <div class="col-md-9">
                                                        <input
                                                            type="text"
                                                            class="form-control"
...
export default {
    ...
    methods: {
        ...mapActions('PackagesSingle', ['fetchData', 'updateData', 'resetState', 'setTitle', 'setPrice', 'setStatus', 'setTests_with_assessment', 'setVideo_tutorials' , 'setPractice_questions','setMock_tests','setPte_vouchers','setWebinar_sessions','setPersonal_feedback_and_assessment','setCoaching_session_daily','setUnique_package_name','setTestcenter_mocktests']),
        updateTitle(e) {
