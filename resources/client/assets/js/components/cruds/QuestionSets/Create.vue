                ...
                <div class="card">
                    <div class="card-header">
                        <span class="cui-utils-title">
                          <strong> Create New Question Set</strong>
                                            ...
                                            <div class="box">
                                                ...
                                                <div>
                                                    <b-tabs content-class="mt-3">
                                                        ...
                                                        <b-tab :title="section.title"  v-for="section in sectionsAll"                                                               
                                                        ...
                                                        <custom-data-table @change=storeSelectedQuestions :selectedRows="JSON.parse(JSON.stringify([]))" :section='section.id' :columns="columns" :childButtons=true :url="'/api/v1/questions-banks?section_type='+section.id" :id="'QuestionSetDataTable_'+section.id" :load="loadTables" :xprops="xprops" :multiselect="true"></custom-data-table>
...
export default {
    data() {
        return {
            ...
            columns: [
                {data:'id', name: 'id', label: "Select", group: 'basic', visible:true},
    ...
    methods: {
        ...mapActions('QuestionSetsSingle', ['storeData', 'resetState', 'setTitle','fetchSectionsAll','setSelectedQuestions']),
        ...mapActions('QuestionsBanksIndex', ['fetchData', 'setQuery','questionIndexResetState']),
        updateTitle(e) {
            this.setTitle(e.target.value)
        },
        updateSection(value){
          console.log("yes we are getting section", value);
        },
        showTable() {
            this.loadTables = true;
        },
        storeSelectedQuestions(value){
          this.setSelectedQuestions(value);
        },
        submitForm() {
            this.storeData()
                .then(() => {
