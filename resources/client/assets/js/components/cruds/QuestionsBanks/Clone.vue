                    ...
                    <form @submit.prevent="submitForm" novalidate>
                        <div class="card-body">
                            <div class="row card-with-shadow pt-3 custom-shadow">
                                <div class="w-100">
                                    <div class="mb-5">
                                        <custom-collapse-heading heading="Question Details" to="basic"></custom-collapse-heading>
                                        <custom-collapse-body uniqueId="basic">
                                            <div class="box">
                                                <div class="box-body">
                                                    ...
                                                    <div class="form-group row" v-bind:class="{ 'has-danger': errors && errors['header'] }">
                                                        <label for="header" class="col-md-3 col-form-label">Header<span class="text-danger">*</span></label>
                                                        <div class="col-md-9">
                                                            <vue-ckeditor
                                                                    :id="'header'"
                                                                    name="header"
                                                                    ...
                                                                    autocomplete="off"
                                                            />
                                                            <bootstrap-error :name="'header'" v-if="errors && errors['header']"/>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group row" v-bind:class="{ 'has-danger': errors && errors['max_score'] }">
                                                                <label for="max_score" class="col-md-6 col-form-label" >Total Max score<span class="text-danger">*</span></label>
                                                                <div class="col-md-6">
                                                                    <input
                                                                            type="number"
                                                                            max="10000"
                                                                    ...
                                                                    >
                                                                    <bootstrap-error :name="'max_score'" v-if="errors && errors['max_score']"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="form-group row"
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input
                                                                        ...
                                                                        :checked="item.include_in_free_package === 'true'"
                                                            ...
                                                            <div class="form-group row"
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input
                                                                        ...
                                                                        :checked="item.include_in_practice_set === 'true'"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group row" v-bind:class="{ 'has-danger': errors && errors['attempt_time'] }" >
                                                                <label for="attempt_time" class="col-md-6 col-form-label"> Attempt Time (in seconds)<span class="text-danger" >*</span></label>
                                                                <div class="col-md-6">
                                                                    <input
                                                                            type="number"
                                                                            max="100000"
                                                                    ...
                                                                    >
                                                                    <bootstrap-error :name="'attempt_time'" v-if="errors && errors['attempt_time']"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group row" v-bind:class="{ 'has-danger': errors && errors['preparation_time'] }">
                                                                <label for="preparation_time" class="col-md-6 col-form-label"> Preparation Time (in seconds)<span class="text-danger">*</span></label>
                                                                <div class="col-md-6">
                                                                    <input
                                                                            type="number"
                                                                            max="1000"
                                                                    ...
                                                                    >
                                                                    <bootstrap-error :name="'preparation_time'"  v-if="errors && errors['preparation_time']" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group row" v-bind:class="{ 'has-danger': errors && errors['section_type'] }" >
                                                                <label for="section_type" class="col-md-3 col-form-label">Section Type<span class="text-danger" >*</span></label>
                                                                <div class="col-md-9">
                                                                    <v-select
                                                                            name="section_type"
                                                                    ...
                                                                    />
                                                                    <bootstrap-error :name="'section_type'" v-if="errors && errors['section_type']"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row" v-if="item.section_type && item.section_type.value == 'writing'">
                                                        <div class="col-md-6">
                                                            <div class="form-group row" v-bind:class="{ 'has-danger': errors && errors['min_words'] }">
                                                                <label for="min_words" class="col-md-6 col-form-label">Answer Word Count From</label>
                                                                <div class="col-md-6">
                                                                    <input
                                                                            type="number"
                                                                            class="form-control w-100"
                                                                            ...
                                                                            min="0"
                                                                    >
                                                                    <bootstrap-error :name="'min_words'" v-if="errors && errors['min_words']"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group row" v-bind:class="{ 'has-danger': errors && errors['max_words'] }" >
                                                                <label for="max_words" class="col-md-6 col-form-label">Answer Word Count To</label>
                                                                <div class="col-md-6">
                                                                    <input
                                                                            type="number"
                                                                            class="form-control w-100"
                                                                            ...
                                                                            min="0"
                                                                    >
                                                                    <bootstrap-error :name="'max_words'" v-if="errors && errors['max_words']"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group row" v-bind:class="{ 'has-danger': errors && errors['question_type'] }">
                                                                <label for="question_type" class="col-md-3 col-form-label" >Question type<span class="text-danger">*</span> </label>
                                                                <div class="col-md-9">
                                                                    <v-select
                                                                            name="question_type"
                                                                            label="title"
                                                                    ...
                                                                    />
                                                                    <bootstrap-error :name="'question_type'" v-if="errors && errors['question_type']"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group row" v-bind:class="{ 'has-danger': errors && errors['answer_type'] }">
                                                                <label for="answer_type" class="col-md-3 col-form-label" >Answer type<span class="text-danger" >*</span></label>
                                                                <div class="col-md-9">
                                                                    <v-select
                                                                            name="answer_type"
                                                                            label="title"
                                                                    ...
                                                                    />
                                                                    <bootstrap-error :name="'answer_type'" v-if="errors && errors['answer_type']"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="box">
                                                <div class="box-footer mt-5">
                                                    <div class="form-group row"
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="row">
                                                                <label for="count_in_overall_score" class="text-center col-md-12 col-form-label">Count In Communicative Score</label>
                                                                <div class="col-md-12 text-center">
                                                                    <input
                                                                            type="checkbox"
                                                        ...
                                                        <div class="col-md-2">
                                                            <button
                                                                    type="button"
                                                                    class=" btn btn-purple btn-rounded mt-3 "
                                                                    name="saveSkills"
                                                        ...
                                                        <div class="col-md-12">
                                                            <table class="table table-bordered">
                                                                ...
                                                                <tr v-for="(qskill,index) in item.question_skills" :key="index">
                                                                    ...
                                                                    <td><button type="button" class="text-danger" @click="deleteQuestionSkill(index)">Delete</button></td>
                                                                </tr>
                        ...
                        <div class="card-body">
                            <div class="row card-with-shadow pt-3 custom-shadow">
                                <div class="w-100">
                                    <div class="mb-5">
                                        <custom-collapse-heading heading="Add Solution" to="question_details"></custom-collapse-heading>
                                        <custom-collapse-body uniqueId="question_details">
                                            <div class="box">
                                                <div class="box-footer mt-5">
                                                    <div class="form-group row" v-bind:class="{ 'has-danger': errors && errors['learning_material'] }">
                                                        <label for="learning_material" class="col-md-3 col-form-label">Learning Material Set <span class="text-danger">*</span> </label>
                                                        <div class="col-md-9">
                                                            <v-select
                                                                    label="title"
                                                                    ...
                                                                    autocomplete="off"
                                                            />
                                                            <bootstrap-error :name="'learning_material_set'"  v-if="errors && errors['learning_material_set']"/>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row" v-bind:class="{ 'has-danger': errors && errors['learning_material_documents'] }">
                                                        <label for="learning_material_documents" class="col-md-3 col-form-label">Learning Material Documents <span class="text-danger">*</span> </label>
                                                        <div class="col-md-9">
                                                            <v-select
                                                                    label="title"
                                                                    ...
                                                                    :multiple="true"
                                                            />
                                                            <bootstrap-error :name="'learning_material_documents'"  v-if="errors && errors['learning_material_documents']"/>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row" v-bind:class="{ 'has-danger': errors && errors['solution_html'] }">
                                                        <label for="solution_html" class="col-md-3 col-form-label">Solution HTML</label>
                                                        <div class="col-md-9">
                                                            <vue-ckeditor
                                                                    :id="'solution_html'"
                                                                    name="solution_html"
                                                    ...
                                                    <div class="form-group row" v-bind:class="{ 'has-danger': errors && errors['file'] }">
                                                        ...
                                                        <div class="col-md-9">
                                                            ...
                                                            >
                                                                ...
                                                                <!-- Scoped slot -->
                                                                <template slot="files" slot-scope="file_props" v-if="item.solution_documents">
                                                                    <div>
                                                                        <ul v-if="item.solution_documents" class="list-unstyled">
                                                                            <li v-for="file in item.solution_documents" v-if="item.solution_documents">
                                                                                {{ file.file_name }}
                                                                                <button
                                                                        ...
                                                                        <div
                                                                            v-for="(file, i) in file_props.files"
                                                                            :key="file.id"
                                                                            :class="{'mt-5': i === 0}"
                                                                            class="row" v-if="file_props"
                                                                        >
                                                                            <div class="media">
                                                            ...
                                                            <bootstrap-error :name="'file'" v-if="errors && errors['file']"/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<script>
    ...
    import QuestionTypeInput from "../QuestionsTypes/EditInput.vue";
    import AnswerTypeInput from "../QuestionsTypes/EditAnswersInput.vue";
    ...
    export default {
        ...
        methods: {
            ...
            updateCreated_by(value) {
                this.setCreated_by(value);
            },
            updateUpdated_by(value) {
            ...
            updateQuestionDetails() {
                console.log("in updateQuestionDetails");
                return;
                let context = this;
            ...
            updateAnswerDetails() {
                console.log("in updateAnswerDetails");
                return;
                let context = this;
                if (context.item && !context.item.answer_details) {
                    context.setAnswer_details({});
                }
                if (
                    context.item &&
                    context.item.answer_type &&
                    context.item.answer_type.configurations
                ) {
            ...
            updateAnswerDetailValue(key, value) {
                console.log("updateAnswerDetailValue key: ", key);
                console.log("updateAnswerDetailValue value: ", value);
            ...
            removeUploadedFile(e, id) {
                this.$swal({
                    ...
                    if (typeof result.dismiss === "undefined") {
                        console.log("here remove",id);
                        this.removeSolutionDocuments(id);
                    }
                });
            },
