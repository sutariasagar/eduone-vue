                ...
                <div class="card">
                    <div class="card-header">
                        <span class="cui-utils-title">
                            <strong> Update Questions Type</strong>
                                            ...
                                            <div class="box">
                                                ...
                                                <div class="box-body">
                                                    ...
                                                    <div class="form-group row"
                                                        ...
                                                        <label for="sequence" class="col-md-3 col-form-label">Sequence <span
                                                                class="text-danger">*</span> </label>
                                                        <div class="col-md-6">
                                                            <input
                                                                    type="number"
...
<script>
    ...
    export default {
        ...
        methods: {
            ...mapActions('QuestionsTypesSingle', ['updateData', 'resetState', 'setTitle', 'setConfigurations','fetchData','setSequence','setCommunication_skill','fetchCommunicationskillsAll']),
            updateTitle(e) {
