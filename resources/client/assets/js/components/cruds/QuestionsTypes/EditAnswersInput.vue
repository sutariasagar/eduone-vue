...
<script>
    ...
    import OrderedText from "../AnswersTypes/EditAnswerOrderedText.vue";
    import OrderedImages from "../AnswersTypes/EditAnswerOrderedImages.vue";
    import MCQSingleOption from "../AnswersTypes/EditAnswerMCQSingleOption.vue";
    import MCQMultipleOption from "../AnswersTypes/EditAnswerMCQMultipleOption.vue";
    ...
    import AnswerSelectText from "../AnswersTypes/EditAnswerSelectText.vue";

    export default {
        name: "EditAnswerTypeInput",
        ...
        methods: {
            ...
            htmlTextChanges: function(id, value) {
            ...
            htmlText2Changes: function(id, value){
            ...
            imageUploaded: function (id, value) {
            ...
            audioUploaded: function (id, value) {
