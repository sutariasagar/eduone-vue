                ...
                <div class="card">
                    <div class="card-header">
                        <span class="cui-utils-title">
                            <strong> View Questions Types</strong>
                        ...
                        <div class="row card-with-shadow pt-3 custom-shadow">
                            ...
                            <div class="w-100">
                                <div class="mb-5">
                                        ...
                                        <table class="table table-bordered table-striped">
                                            <tbody>
                                                ...
                                                <th>Communication Skill</th>
                                                    <td>
                                                        <span class="label label-info" v-if="item.communication_skill !== null">
                                                            {{ item.communication_skill.title }}
                                                        </span>
                                                    </td>
                                                </tr>
                                            </tbody>
                                    ...
                                    <back-to-index :linkname="'questions_types.index'"></back-to-index>
                                </div>
                            </div>
                        </div>
                    </div>
...
export default {
    ...
    computed: {
        ...mapGetters('QuestionsTypesSingle', ['item'])
    },
    watch: {
    ...
    methods: {
        ...mapActions('QuestionsTypesSingle', ['fetchData', 'resetState']),
        toggleColumns(){
