<template>
   <section class="card" >
        <custom-data-table :columns="columns" :url="'/api/v1/roles'" :id="'RolesDataTable'" :load="loadTables" :xprops="xprops"></custom-data-table>
    </section>
</template>
    ...
    data() {
        return {            
            ...
            columns: [
               ...
               // {data: 'permission', name: 'permission', searchable: false, label: "Permissions",orderable: "false", group: 'advanced', type: 'html'},
