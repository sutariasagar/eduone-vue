                ...
                <div class="card">
                    ...
                    <div class="card-body ">
                        ...
                        <div class="box">
                            ...
                            <div class="form-group row" v-bind:class="{ 'has-danger': errors && errors['enabling_skill'] }">
                                <label for="enabling_skill" class="col-md-3 col-form-label">Enabling Skill <span class="text-danger">*</span> </label>
                                <div class="col-md-9">
                                    <v-select
                                            label="title"
                                            name="enabling_skill"
                                            placeholder="Enter Enabling Skill *"
                                            :value="item.enabling_skill"
                                            @input="updateEnablingSkill"
                                            :options="enablingSkillsAll"
                                            autocomplete="off"
                                    />
                                    <bootstrap-error :name="'course'" v-if="errors && errors['enabling_skill']"/>
                                </div>
                            </div>
...
export default {
    data() {
      ...
      mounted() {
        ...
        context.fetchEnablingSkillsAll();
      },
    computed: {
        ...mapGetters('SkillsSingle', ['item', 'loading','enablingSkillsAll']),
    ...
    methods: {
        ...mapActions('SkillsSingle', ['storeData', 'resetState', 'setTitle','setEnablingSkill','fetchEnablingSkillsAll']),
        updateTitle(e) {
            this.setTitle(e.target.value)
        },
          updateEnablingSkill(value) {
            this.setEnablingSkill(value)
          },
        submitForm() {
            this.storeData()
                .then(() => {
