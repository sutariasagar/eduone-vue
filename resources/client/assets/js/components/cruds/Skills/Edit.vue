                    ...
                    <div class="card-body ">
                        ...
                        <div class="box">
                            ...
                            <div class="form-group row" v-bind:class="{ 'has-danger': errors && errors['enabling_skill'] }">
                                <label for="enabling_skill" class="col-md-3 col-form-label">Enabling Skill *</label>
                                <div class="col-md-9">
                                    <v-select
                                            name="enabling_skill"
                                            label="title"
...
export default {
    ...
    methods: {
        ...mapActions('SkillsSingle', ['fetchData', 'updateData', 'resetState', 'setTitle','setEnablingSkill']),
        updateTitle(e) {
