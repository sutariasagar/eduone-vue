                                            ...
                                            <div class="box">
                                                <div class="box-body">
                                                    ...
                                                    <div class="form-group row" v-bind:class="{ 'has-danger': errors && errors['registration_id'] }">
                                                        <label for="registration_id" class="col-md-3 col-form-label">Registration Id * </label>
                                                        <div class="col-md-3">
                                                            <input
                                                                type="text"
                                                                class="form-control"
                                                     ...
                                                     <div class="form-group row" v-bind:class="{ 'has-danger': errors && errors['test_taker_id'] }">
                                                        <label for="test_taker-id" class="col-md-3 col-form-label">Test Taker Id * </label>
                                                        <div class="col-md-3">
                                                            <input
                                                                type="text"
                                                                class="form-control"
                                                    ...
                                                    <div class="form-group row" v-bind:class="{ 'has-danger': errors && errors['package'] }">
                                                        <label for="package" class="col-md-3 col-form-label">Package * </label>
                                                        <div class="col-md-9">
                                                            <v-select
                                                                label="title"
                                                                name="package"
                                                        ...
                                                        <div class="col-md-9">
                                                            ...
                                                            >
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="media">
                                                                        <img
                                                                            :src="'/storage/'+item.student_image.id+'/'+item.student_image.file_name"
                                                                            class="img-fluid d-flex mr-3"
                                                                        />
                                                                        <div class="media-body">
                                                                            <h3>{{ item.student_image.file_name }}</h3>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </vue-transmit>
                                                    ...
                                                    <div class="form-group row">
                                                        <img class="img" :src="item.capture_image">
                                                    </div>

                                                    <div>
                                                        <b-button v-b-modal.credentialmodal @click="fetchCredentials">Get Credential</b-button>
                                                        <b-button v-b-modal.changePasswordCredential>Change Password</b-button>

                                                        <b-modal  ref="student" id="credentialmodal" :hide-footer='false' header-class='custom-sidebar-no-hover' title="Login Information" ok-only>
                                                        ...
                                                        <b-modal ref="student" id="changePasswordCredential" :hide-footer='false' header-class='custom-sidebar-no-hover' title="Change Password" ok-only>
                                                            <div class="d-block text-center pt-5 pb-5">
                                                                <!-- <h4>Email : {{item.email}} </h4>
                                                                <h4>Password : {{password}} </h4>
                                                                <h4 v-if="item.terminal">Terminal : {{item.terminal.title}} </h4>
                                                                ...
                                                                <input type="password" name="reset_password" @input="updatePassword">
                                                                <b-button  class="btn btn-purple" @click="resetPassword">SUBMIT</b-button>
                                                            </div>
                                                        </b-modal>
                                                    </div>
                                                </div>
...
export default {
    ...
    methods: {
        ...mapActions('StudentsSingle', ['fetchData', 'resetStudentPassword', 'updateData', 'updatePassword', 'resetState', 'setFirst_name', 'setLast_name', 'setMiddle_name','setEmail','setPhone','setCountry','setState', 'setCity','setType','setPackage','setPassword','getCredential','setRegistration_id','setTest_taker_id','setDate_of_birth','setGender','setStudentImage','setCaptureImage','setStudentPassword']),
        updateFirst_name(e) {
        ...
        updatePassword(e){
            //console.log('call')
            this.setStudentPassword(e.target.value)
        ...
        resetPassword(){
            this.resetStudentPassword(this.$route.params.id)
            .then(() => {
                    console.log("nvjvjjvi");
                    this.$router.push({ name: 'students.index' })
                    this.$eventHub.$emit('update-password-success')
                    this.$refs.student.show()
                })
                .catch((error) => {
                    console.error(error)
