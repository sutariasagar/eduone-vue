<template>
    <section class="card" >
        <custom-data-table :columns="columns" :url="'/api/v1/subjects'" :id="'SubjectsDataTable'" :load="loadTables" :xprops="xprops"></custom-data-table>
    </section>
</template>
    ...
    data() {
        return {
            ...
            columns: [
                    ...
                    {data: 'course', name: 'course.title', searchable: true, label: "Course",orderable: "false",group: 'advanced'},
