                ...
                <div class="card">
                    <div class="card-header">
                        <span class="cui-utils-title">
                          <strong> Create New Terminal</strong>
...
export default {
    ...
    computed: {
        ...mapGetters('TerminalsSingle', ['item', 'loading']),
    ...
    methods: {
        ...mapActions('TerminalsSingle', ['storeData', 'resetState', 'setTitle']),
        updateTitle(e) {
        ...
        submitForm() {
            this.storeData()
                .then(() => {
                    this.$router.push({ name: 'terminals.index' })
