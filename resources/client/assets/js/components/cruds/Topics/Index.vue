<template>
    <section class="card">
        <custom-data-table  :columns="columns" :url="'/api/v1/topics'" :id="'TopicsDataTable'" :load="loadTables" :xprops="xprops"></custom-data-table>
    </section>
</template>
    ...
    data() {
        return {                
            ...
            columns: [
                ...
                {data: 'chapter',name: 'chapter.title', searchable: true, label: "Chapter", group: 'advanced'},
                {data: 'learning_sequence',name: 'learning_sequence', searchable: true, visible:false, label: "Learning Sequence",group: 'advanced'},
                {data: 'parent',name: 'parent.title', searchable: false, visible:false, label: "Parent Topic",group: 'advanced'},
