<template>
    <section class="card" >
        <custom-data-table :columns="columns" :url="'/api/v1/users'" :id="'UsersDataTable'" :load="loadTables" :xprops="xprops"></custom-data-table>
    </section>
</template>
    ...
    data() {
        return {
            ...
            columns: [
                    ...
                    {data: 'name', name: 'name', searchable: true, label: "Name", group: 'basic'},
                    {data: 'email', name: 'email', searchable: true, label: "Email", orderable: "false",group: 'advanced'},
                    //{data: 'role', name: 'role.title', searchable: true, label: "Role", orderable: "false",group: 'advanced'},
