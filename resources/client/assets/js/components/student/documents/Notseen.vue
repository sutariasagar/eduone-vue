            ...
            <div v-bind:class="{'col-md-12':!showSummary,'col-md-9':showSummary}">
                <div class="card">
                    ...
                    <b-tabs content-class="mt-3 p-3" class="p-3">
                        <b-tab :title="subject.title" v-for="subject in coursesAndChaptersDocumentsNotSeen" v-bind:key="'subject_'+subject.id">
                                        ...
                                        <div class="mb-5" >                                    
                                            ...
                                            <div class="cui-video-page-feeds">
                                                ...
                                                <ul class="cui-video-page-partition-content" v-for="learning_materials in chapter.learning_materials" v-bind:key="learning_materials.id">
                                                    <li class="cui-video-page-next-item cui-video-page-next-item-feed" v-for="learning_materials_documents in learning_materials.learning_material_p_d_f_documents" v-bind:key="learning_materials_documents.id">
                                                        
                                                        <a v-if="learning_materials_documents.file_tag && learning_materials_documents.file_tag.length > 0" :href="learning_materials_documents.file_tag[0].src" target="_blank" class="cui-video-page-next-item-link">
...
export default {
    ...
    created() {
        ...
        this.fetchCoursesAndChaptersDocumentsNotSeen()
    },
    destroyed() {
        
    },
    mounted() {
        console.log("item",this.coursesAndChaptersDocumentsNotSeen)
    },
    components: {

    },
    computed: {
        ...mapGetters('StudentPanel', ['coursesAndChaptersDocumentsNotSeen'])
    },
    watch: {
        
    },
    methods: {
        ...mapActions('StudentPanel', ['fetchCoursesAndChaptersDocumentsNotSeen', 'resetState']),
        toggleColumns(){
