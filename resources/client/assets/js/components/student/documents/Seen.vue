            ...
            <div v-bind:class="{'col-md-12':!showSummary,'col-md-9':showSummary}">
                <div class="card">
                    ...
                    <b-tabs content-class="mt-3 p-3" class="p-3">
                        <b-tab :title="subject.title" v-for="subject in coursesAndChaptersDocumentsSeen" v-bind:key="'subject_'+subject.id">
...
export default {
    ...
    created() {
        ...
        this.fetchCoursesAndChaptersDocumentsSeen()
    },
    destroyed() {
    ...
    computed: {
        ...mapGetters('StudentPanel', ['coursesAndChaptersDocumentsSeen'])
    },
    watch: {
        
    },
    methods: {
        ...mapActions('StudentPanel', ['fetchCoursesAndChaptersDocumentsSeen', 'resetState']),
        toggleColumns(){
