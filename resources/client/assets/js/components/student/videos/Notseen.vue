            ...
            <div v-bind:class="{'col-md-12':!showSummary,'col-md-9':showSummary}">
                <div class="card">
                    ...
                    <b-tabs content-class="mt-3 p-3" class="p-3">
                        <b-tab :title="subject.title" v-for="subject in coursesAndChaptersNotSeen" v-bind:key="'subject_'+subject.id">
                                        ...
                                        <div class="mb-5" >                                    
                                            ...
                                            <div class="cui-video-page-feeds">
                                                ...
                                                <ul class="cui-video-page-partition-content" v-for="learning_materials in chapter.learning_materials" v-bind:key="learning_materials.id">
                                                    <li class="cui-video-page-next-item cui-video-page-next-item-feed" v-for="learning_materials_documents in learning_materials.learning_material_videos" v-bind:key="learning_materials_documents.id">
                                                        ...
                                                        <div class="cui-video-page-item-descr">
                                                            <span class="cui-video-page-item-name">{{learning_materials_documents.title}}</span>
...
export default {
    ...
    created() {
        ...
        this.fetchCoursesAndChaptersNotSeen()
    },
    destroyed() {
    ...
    computed: {
        ...mapGetters('StudentPanel', ['coursesAndChaptersNotSeen'])
    },
    watch: {
        
    },
    methods: {
        ...mapActions('StudentPanel', ['fetchCoursesAndChaptersNotSeen', 'resetState','fetchLearningVideos','setPlayedDocument']),
        toggleColumns(){
