            ...
            <div v-bind:class="{'col-md-12':!showSummary,'col-md-9':showSummary}">
                <div class="card">
                    ...
                    <b-tabs content-class="mt-3 p-3" class="p-3">
                        <b-tab :title="subject.title" v-for="subject in coursesAndChaptersSeen" v-bind:key="'subject_'+subject.id">
                                        ...
                                        <div class="mb-5" >                                    
                                            ...
                                            <div class="cui-video-page-feeds">
                                                ...
                                                <ul class="cui-video-page-partition-content" v-for="learning_materials in chapter.learning_materials" v-bind:key="learning_materials.id">
                                                    <li class="cui-video-page-next-item cui-video-page-next-item-feed" v-for="learning_materials_documents in learning_materials.learning_material_videos_seen" v-bind:key="learning_materials_documents.learning_material_documents.id">                                                        
                                                        <a href="#" class="cui-video-page-next-item-link">
                                                        <div class="cui-video-page-item-thumb">
                                                            <video-player :sources="learning_materials_documents.learning_material_documents.file_tag" :customId="learning_materials_documents.learning_material_documents.id" @play="documentPlayed"></video-player>
                                                        </div>
                                                        <div class="cui-video-page-item-descr">
                                                            <span class="cui-video-page-item-name">{{learning_materials_documents.learning_material_documents.title}}</span>
                                                            <span class="cui-video-page-item-author" v-html="learning_materials_documents.learning_material_documents.description"></span>
...
export default {
    ...
    created() {
        ...
        this.fetchCoursesAndChaptersSeen()
    },
    destroyed() {
    ...
    computed: {
        ...mapGetters('StudentPanel', ['coursesAndChaptersSeen'])
    },
    watch: {
        
    },
    methods: {
        ...mapActions('StudentPanel', ['fetchCoursesAndChaptersSeen', 'resetState','fetchLearningVideos','setPlayedDocument']),
        toggleColumns(){
