<template>
  <div class="btn-group" name="HeaderSettings">
    <button class="btn btn-warning dropdown-toggle" ref="dropdownBtn" type="button">
      <i class="fa" :class="[usingBak, processingCls || 'fa-cog']"></i>
    ...
    <div class="dropdown-menu clearfix" :style="drpMenuStyle">
      ...
      <div class="clearfix" style="margin: 10px 0">
        <div class="btn-group btn-group-sm pull-right">
          <button class="btn btn-purple mr-2 btn-md" type="button" @click="apply(true)">
            {{ $i18nForDatatable('Apply') }}
          </button>
          <button class="btn btn-danger btn-md" type="button" @click="rmBackup()">
            Default View
          </button>
