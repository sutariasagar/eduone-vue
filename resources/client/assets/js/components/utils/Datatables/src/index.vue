<template>
  <div name="Datatable">
    <div  class="row mb-3">
      <div class="col-sm-6">
         <input type="text" class="form-control col-sm-8" placeholder="Search" v-model="search" style="height: 40px;">
      </div>
      <div v-if="$slots.default || HeaderSettings" class="col-sm-6">
...
export default {
  ...
  created () {
    ...
    const q = { limit: 10, offset: 0, sort: '', search:'', order: '', ...this.query }
