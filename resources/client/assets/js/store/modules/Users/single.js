...
const actions = {
    ...
    setName({ commit,dispatch }, value) {
        dispatch('Alert/removeError', 'name', { root: true });
    ...
    setPassword({ commit,dispatch }, value) {
        dispatch('Alert/removeError', 'password', { root: true });
        commit('setPassword', value)
    },
    setRole({ commit,dispatch }, value) {
        dispatch('Alert/removeError', 'role', { root: true });
