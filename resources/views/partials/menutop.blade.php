    ...
    <div class="cui-topbar">
                    ...
                    <div class="container-fluid">
                        <div class="cui-topbar-livesearch-wrapper">
                            <div class="cui-topbar-livesearch-logo-container">
                                <img class="cui-topbar-livesearch-logo" src="../../components/dummy-assets/common/img/logo.png" alt="">
                            </div>
                            <input type="search" id="livesearch-input-inner" class="cui-topbar-livesearch-input" placeholder="Type to search...">
                            <ul class="cui-topbar-livesearch-options">
                                <li class="cui-topbar-livesearch-option">
                                    <label class="cui-utils-control cui-utils-control-checkbox">Search within page
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="cui-topbar-livesearch-result-content">
                                            <div class="cui-topbar-livesearch-result-thumb" style="background-image: url('../../components/dummy-assets/common/img/photos/1.jpeg')">
                                                #1
                                            </div>
                                        ...
                                        <div class="cui-topbar-livesearch-result-content">
                                            <div class="cui-topbar-livesearch-result-thumb" style="background-image: url('../../components/dummy-assets/common/img/photos/2.jpeg')">
                                                KF
                                            </div>
                                            <div class="cui-topbar-livesearch-result">
                                                <div class="cui-topbar-livesearch-result-text">
                                        ...
                                        <div class="cui-topbar-livesearch-result-content">
                                            <div class="cui-topbar-livesearch-result-thumb" style="background-image: url('../../components/dummy-assets/common/img/photos/3.jpeg')">
                                                GF
                                            </div>
                                            <div class="cui-topbar-livesearch-result">
                                                <div class="cui-topbar-livesearch-result-text">
        ...
        <div class="cui-topbar-right">
            <div class="cui-topbar-item d-none d-md-block">
                <a href="https://themeforest.net/item/clean-ui-html-bootstrap-admin-template/22827565?ref=mediatec_software" target="_blank" class="btn btn-sm btn-danger">Buy Pro 21$</a>
            </div>
          ...
          <span class="cui-topbar-avatar">
            <img src="../../components/dummy-assets/common/img/avatars/1.jpg" alt="">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" role="menu">
                        ...
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="#logout" onclick="$('#logout').submit();"><i class="dropdown-icon icmn-exit"></i> Logout</a>
                    </a>
                    </div>
                </div>
            </div>
